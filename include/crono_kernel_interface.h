...
#define MAX_NAME 128
#define MAX_DESC 128
//#define MAX_NAME_DISPLAY 22 $$ the three are deleted by dennis latest version
...
#ifdef _WIN32
// $$ defined in crono_driver for linux, should unify them?
typedef struct {
...
CRONO_KERNEL_API uint32_t
CRONO_KERNEL_ReadAddr8(CRONO_KERNEL_DEVICE_HANDLE hDev, uint32_t dwAddrSpace,
                       uint32_t dwOffset, uint8_t *val);
CRONO_KERNEL_API uint32_t
CRONO_KERNEL_ReadAddr16(CRONO_KERNEL_DEVICE_HANDLE hDev, uint32_t dwAddrSpace,
                        uint32_t dwOffset, uint16_t *val);
CRONO_KERNEL_API uint32_t
CRONO_KERNEL_ReadAddr32(CRONO_KERNEL_DEVICE_HANDLE hDev, uint32_t dwAddrSpace,
                        uint32_t dwOffset, uint32_t *val);
CRONO_KERNEL_API uint32_t
CRONO_KERNEL_ReadAddr64(CRONO_KERNEL_DEVICE_HANDLE hDev, uint32_t dwAddrSpace,
                        uint32_t dwOffset, uint64_t *val);

CRONO_KERNEL_API uint32_t
CRONO_KERNEL_WriteAddr8(CRONO_KERNEL_DEVICE_HANDLE hDev, uint32_t dwAddrSpace,
                        uint32_t dwOffset, uint8_t val);
CRONO_KERNEL_API uint32_t
CRONO_KERNEL_WriteAddr16(CRONO_KERNEL_DEVICE_HANDLE hDev, uint32_t dwAddrSpace,
                         uint32_t dwOffset, uint16_t val);
CRONO_KERNEL_API uint32_t
CRONO_KERNEL_WriteAddr32(CRONO_KERNEL_DEVICE_HANDLE hDev, uint32_t dwAddrSpace,
                         uint32_t dwOffset, uint32_t val);
CRONO_KERNEL_API uint32_t
CRONO_KERNEL_WriteAddr64(CRONO_KERNEL_DEVICE_HANDLE hDev, uint32_t dwAddrSpace,
                         uint32_t dwOffset, uint64_t val);
...
//$$ replace by more standard debug
#ifdef __linux__
/**
